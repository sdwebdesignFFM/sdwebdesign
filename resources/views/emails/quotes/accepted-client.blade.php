...
<head>
    ...
    <title>Vertragsbestätigung</title>
</head>
        ...
        <tr>
            <td style="padding: 40px 20px;">
                <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
                    ...
                    <tr>
                        <td style="background-color: #16a34a; padding: 32px 40px;">
                            ...
                            <p style="margin: 8px 0 0; color: rgba(255,255,255,0.9); font-size: 14px;">
                                Ihr Angebot wurde erfolgreich angenommen.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 32px 40px 24px;">
                            ...
                            <p style="margin: 16px 0 0; font-size: 14px; color: #404040; line-height: 1.6;">
                                wir freuen uns, dass Sie sich für uns entschieden haben. Hiermit bestätigen wir den Eingang Ihrer Auftragsannahme.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px;">
                            <div style="background-color: #f0fdf4; border-radius: 8px; padding: 24px; border: 1px solid #bbf7d0;">
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td style="padding: 8px 0; font-size: 14px; color: #166534;">Angebotsnummer:</td>
                                        <td style="padding: 8px 0; font-size: 14px; color: #166534; text-align: right; font-weight: 500;">{{ $quote->quote_number }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; font-size: 14px; color: #166534;">Angenommen am:</td>
                                        <td style="padding: 8px 0; font-size: 14px; color: #166534; text-align: right; font-weight: 500;">{{ $quote->accepted_at->format('d.m.Y \u\m H:i') }} Uhr</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px 0; font-size: 14px; color: #166534;">Angenommen von:</td>
                                        <td style="padding: 8px 0; font-size: 14px; color: #166534; text-align: right; font-weight: 500;">{{ $quote->accepted_name }}</td>
                                    </tr>
                                    <tr>
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px;">
                            <div style="background-color: #f3f4f6; border-radius: 6px; padding: 16px; border-left: 4px solid #6b7280;">
                                <p style="margin: 0; font-size: 14px; color: #374151;">
                                    <strong>Anhang:</strong> Im Anhang dieser E-Mail finden Sie Ihr unterschriebenes Angebot als PDF-Dokument zur Aufbewahrung.
                                </p>
                            </div>
                        </td>
                    </tr>

...
class DinoHairReferenceTest extends TestCase
{
    use RefreshDatabase;

    private const SLUG = 'dino-hair-friseursalon-frankfurt';

    private const MIGRATION = 'migrations/2026_07_21_211943_add_dino_hair_reference.php';
                ...
                'de' => [
                    ...
                    'projects' => [
                        [
                            'icon' => 'sparkles',
                            'number' => '01',
                            'title' => 'Kosmetikerin.org – SaaS-Plattform & iOS-App',
    ...
    private function seedExistingDetailPage(Page $overview): Page
    {
        return Page::factory()->create([
            ...
            'slug' => ['de' => 'pureheat-online-woocommerce-b2b-shop', 'en' => 'pureheat-online-woocommerce-b2b-shop'],
            'title' => ['de' => 'PureHeat-Online'],
            'is_active' => true,
            'sort_order' => 9,
            'content' => ['de' => []],
        ]);
    ...
    public function test_migration_creates_detail_page(): void
    {
        ...
        $this->assertStringContainsString('Dino Hair', $page->getTranslation('title', 'de'));
    }
    ...
    public function test_detail_sort_order_is_after_existing_references(): void
    {
        ...
        $this->assertSame(10, Page::firstWhere('slug->de', self::SLUG)->sort_order);
    }
    ...
    public function test_detail_section_shapes_are_render_safe(): void
    {
        ...
        $this->assertCount(3, $content['features']);
    ...
    public function test_is_appended_as_last_overview_project(): void
    {
        ...
        $this->assertSame('Dino Hair', $last['client']);
    ...
    public function test_detail_page_renders_with_core_sections(): void
    {
        ...
        $response->assertSee('Dino Hair', false);
        $response->assertSee('Google-Ads-Betreuung', false);
        $response->assertSee('Suchmaschinenoptimierung', false);
